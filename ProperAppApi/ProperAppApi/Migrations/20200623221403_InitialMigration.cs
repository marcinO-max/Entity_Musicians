...
namespace ProperAppApi.Migrations
{
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MusicTracks", x => x.IdMusicianTrack);
                    table.ForeignKey(
                        name: "FK_MusicTracks_Musicians_IdMusician",
                        column: x => x.IdMusician,
                        principalTable: "Musicians",
                        principalColumn: "IdMusician",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MusicTracks_Tracks_IdTrack",
                        column: x => x.IdTrack,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MusicTracks_IdMusician",
                table: "MusicTracks",
                column: "IdMusician");

            migrationBuilder.CreateIndex(
                name: "IX_MusicTracks_IdTrack",
                table: "MusicTracks",
                column: "IdTrack");
